export const ROLE_MODIFIERS_LOCAL = {
    amnesias: { 
        ...
        grad: 'linear-gradient(135deg, rgb(39, 180, 245) 0%, rgb(20, 90, 123) 100%)',
    ...
    mimes: { 
        ...
        grad: 'linear-gradient(135deg, rgb(0, 0, 0) 0%, rgb(255, 255, 255) 100%)',
    ...
    dumb: {
        ...
        grad: 'linear-gradient(135deg, rgb(78, 168, 9) 0%, rgb(36, 84, 0) 100%)',
    ...
    teacher: {
        ...
        grad: 'linear-gradient(135deg, rgb(9, 97, 168) 0%, rgb(5, 49, 84) 100%)',
    ...
    terrorist: {
        ...
        grad: 'linear-gradient(135deg, rgb(235, 87, 42) 0%, rgb(118, 44, 21) 100%)',
        textColor: 'orangered',
    ...
    scholar: {
        ...
        grad: 'linear-gradient(135deg, rgb(93, 63, 211) 0%, rgb(21, 10, 60) 100%)',
    ...
    npc: {
        ...
        grad: 'linear-gradient(135deg, rgb(209, 137, 115) 0%, rgb(105, 69, 58) 100%)',
        textColor: 'peru',
    ...
    monkey: {
        ...
        grad: 'linear-gradient(135deg, rgb(77, 43, 33) 0%, rgb(59, 19, 7) 100%)',
...
export const ROLE_DATA_LOCAL = {
    innocents: {
        ...
        grad: 'linear-gradient(135deg, rgb(0, 255, 0) 0%, rgb(0, 128, 0) 100%)',
        textColor: 'lime',
        showWord: true,
        selectable: true
    },
    imposters: {
        ...
        class: 'imposter',
        tip: 'Dont get caught!',
        grad: 'linear-gradient(135deg, rgb(255, 0, 0) 0%, rgb(128, 0, 0) 100%)',
        textColor: 'red',
        showWord: false,
        selectable: true
    },
    jesters: {
        ...
        grad: 'linear-gradient(135deg, rgb(255, 0, 255) 0%, rgb(128, 0, 128) 100%)',
    ...
    hitmans: {
        ...
        grad: 'linear-gradient(135deg, rgb(84, 84, 255) 0%, rgb(42, 42, 128) 100%)',
    ...
    guardian_angels: {
        ...
        grad: 'linear-gradient(135deg, rgb(199, 255, 249) 0%, rgb(100, 128, 125) 100%)',
    ...
    alphas: {
        ...
        grad: 'linear-gradient(135deg, rgb(200, 200, 200) 0%, rgb(100, 100, 100) 100%)',
    ...
    inspectors: {
        ...
        grad: 'linear-gradient(135deg, rgb(235, 183, 42) 0%, rgb(118, 92, 21) 100%)',
        textColor: 'goldenrod',
        showWord: true,
        hasClue: true,
        selectable: true
